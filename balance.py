...
class Ui_BalanceWindow(object):
    def setupUi(self, BalanceWindow):
        ...
        self.label_result.setGeometry(QtCore.QRect(0, 80, 301, 111))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_result.setFont(font)
        self.label_result.setObjectName("label_result")
        self.pushButton_show_balance = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_show_balance.setGeometry(QtCore.QRect(160, 190, 141, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.pushButton_show_balance.setFont(font)
        self.pushButton_show_balance.setObjectName("pushButton_show_balance")
        self.pushButton_back = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_back.setGeometry(QtCore.QRect(10, 190, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, BalanceWindow):
        ...
        self.pushButton_show_balance.setText(_translate("BalanceWindow", "Показать"))
        self.pushButton_back.setText(_translate("BalanceWindow", "Назад"))
